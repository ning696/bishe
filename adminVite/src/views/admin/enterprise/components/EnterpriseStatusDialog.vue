<template>
  <el-dialog v-model="visibleLocal" title="更新企业状态" width="420px" :close-on-click-modal="false">
...
import { updateEnterpriseStatus } from '@/api/admin/enterprise'
...
const onSubmit = async () => {
  ...
  try {
    await updateEnterpriseStatus({ enterpriseId: props.enterpriseId, status: form.value.status as number })
