<template>
  <div class="student-interview-apply" v-loading="loading">
    <el-page-header content="申请面试" @back="router.back()" />
    ...
    <el-card shadow="never">
      <el-form label-width="100px" class="apply-form">
        ...
        <el-form-item>
          <el-button type="warning" :loading="submitting" :disabled="!canSubmit" @click="submit">
            提交申请
          </el-button>
...
const submit = async () => {
  ...
  try {
    await applyInterview({ jobId: jobId.value, resumeId: resumeId.value })
    ElMessage.success('申请已提交，请等待企业处理')
