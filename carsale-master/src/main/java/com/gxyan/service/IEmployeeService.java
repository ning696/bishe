...
public interface IEmployeeService {
    ...
    ServerResponse updatePassword(Long id, String oldPass, String newPass);
    ServerResponse updateCustomerPassword(Long id, String oldPass, String newPass);

    ServerResponse validCustomerPassword(Long id, String validPass);
}
