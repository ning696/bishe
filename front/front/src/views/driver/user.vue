<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="driveList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="预约车辆" align="center" prop="carModel" />
      <el-table-column label="车辆颜色" align="center" prop="carColor" />
      <el-table-column label="预约人姓名" align="center" prop="customerName" />
...
<script>
import { addDrive, updateDrive, refuse, getuserdriverList } from '../../api/drive'
...
export default {
  ...
  created() {
    this.getuserdriverList()
  },
  methods: {
    /** 查询drive列表 */
    getuserdriverList() {
      getuserdriverList(this.$store.getters.token).then(response => {
